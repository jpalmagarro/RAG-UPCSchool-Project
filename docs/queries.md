...
🔍 Factual directa (respuesta explícita al documento)
...
🏗️ Técnica / específica de construcción

"¿Cómo proteger la tubería de columna seca en el tramo enterrado del andén?"


"¿Cuál es el diámetro del tubo dren especificado para la impermeabilización de los muros?"


"¿A qué altura respecto al suelo se van a instalar las unidades exteriores de climatización?"


📋 Estado y seguimiento (temas pendientes)

"¿Cuál es el estado actual de la gestión del informe de conexión de acometida pluvial con Drenajes Besós?"


"¿Qué certificados de material debe aportar la UTE sobre las hincas de perfiles?"


🔗 Inferencia / relación entre puntos

"¿Qué elementos, aparte de las luminarias, soportarán los báculos del andén?"


"¿Por qué motivo la DF solicita fotografías del proceso constructivo del tubo dren?"


❌ Out-of-scope (para testar alucinación — el RAG debería decir que no sabe)

"¿Cuál es el presupuesto total de la obra?"


"¿Qué operarios han trabajado en el hormigonado de los muros?"
